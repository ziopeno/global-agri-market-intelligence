...
`db:seed`는 기본 제품, 제품 민감도, 샘플 기사, 초기 RSS Source를 생성합니다.
...
3. 실패 Source가 있으면 URL 변경, RSS 접근 제한, feed 형식 오류를 점검합니다.
4. `/news`에서 신규 기사와 AI 분석 상태를 확인합니다.
5. `/reports`에서 Daily Report가 업데이트되었는지 확인합니다.

## 관리 원칙

- RSS Source는 너무 많이 넣기보다 신뢰도 높은 Source부터 운영합니다.
